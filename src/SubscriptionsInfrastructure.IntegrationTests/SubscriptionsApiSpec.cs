...
/// <summary>
///     We are testing the API with the built-in <see cref="SimpleBillingProvider" />
/// </summary>
[Trait("Category", "Integration.API")]
[Collection("API")]
public class SubscriptionsApiSpec : WebApiSpec<Program>
{
    public SubscriptionsApiSpec(WebApiSetup<Program> setup) : base(setup, OverrideDependencies)
    {
